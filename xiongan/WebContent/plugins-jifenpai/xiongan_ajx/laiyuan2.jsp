...
<%
	...
	//4.执行SQL语句
	ResultSet rs = statement .executeQuery("select 市人数_石家庄,市人数_唐山,市人数_秦皇岛,市人数_邯郸,市人数_邢台,市人数_保定,市人数_张家口,市人数_承德,市人数_沧州,市人数_廊坊,市人数_衡水 from 行政区  where 中区 ='"+index+"' and 日期 = (select max(日期) from 行政区) ");
