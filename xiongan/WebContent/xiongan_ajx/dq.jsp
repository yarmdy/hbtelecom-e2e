...
<%
	...
	//4.执行SQL语句
	ResultSet rs = statement .executeQuery("select 中区,总人数_倒数第7天,总人数_倒数第6天,总人数_倒数第5天,总人数_倒数第4天,总人数_倒数第3天,总人数_倒数第2天,总人数_倒数第1天,日期__倒数第7天,日期__倒数第6天,日期__倒数第5天,日期__倒数第4天,日期__倒数第3天,日期__倒数第2天,日期__倒数第1天 from 大区质态   where 中区 ='"+index+"'");
