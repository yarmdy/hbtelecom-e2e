...
<%
	...
	//4.执行SQL语句
	ResultSet rs = statement .executeQuery("select 年龄人数_20以下,年龄人数_21_30,年龄人数_31_40,年龄人数_41_50,年龄人数_51_60	,年龄人数_61以上 from 行政区  where 中区 ='"+index+"' ");
    
    // 将分类写死 
		String []fenlei = {"20以下","21~30","31~40","41~50","51~60","60以上"} ;
