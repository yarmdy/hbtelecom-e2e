    ...
    return this.each(function() {
      ...
      function setWestAndEast(){
        if(west){
          ...
          if(temp){
            temp = Math.round(calculateLength(temp, width, west._data['min-width'], west._data['max-width']));
            left = temp;
        ...
        if(east){
          ...
          if(temp){
            temp = Math.round(calculateLength(temp, width, east._data['min-width'], east._data['max-width']));
      ...
      function setNorthAndSouth(){
        if(north){
          ...
          if(temp){
            temp = Math.round(calculateLength(temp, height, north._data['min-height'], north._data['max-height']));
            heightRest -= temp;
            top = temp;
        ...
        if(south){
          ...
          if(temp){
            temp = Math.round(calculateLength(temp, height, south._data['min-height'], south._data['max-height']));
            heightRest -= temp ;
